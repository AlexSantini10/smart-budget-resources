...
export const StyleBulk1 = ({ className }) => {
  return (
    ...
    >
      ...
      <path
        className="path"
        d="M14.85 3.95V7.74999H6.26C4.19 7.74999 2.5 9.44 2.5 11.51V7.84002C2.5 6.65002 3.23 5.58997 4.34 5.16997L12.28 2.16997C13.52 1.70997 14.85 2.62 14.85 3.95Z"
        fill="#171717"
      />
      <path
        className="path"
